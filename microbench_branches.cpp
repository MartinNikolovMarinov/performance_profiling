...
bool ConditionalNOP_NeverTaken_TestFn(u64& processedBytes) {
...
bool ConditionalNOP_AlwaysTaken_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
...
bool ConditionalNOP_TakeEvery2_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
...
bool ConditionalNOP_TakeEvery3_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
...
bool ConditionalNOP_TakeEvery4_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
...
bool ConditionalNOP_STDRandom_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
...
bool ConditionalNOP_Random_TestFn(u64& processedBytes) {
    ConditionalNOP(N_COUNT, g_data);
    processedBytes = N_COUNT;
    return false;
}
